...
public class PagoController {
    ...
    public ResponseEntity<?> pagar(
        ...
        // El pedido tiene que ser del cliente autenticado. Antes se buscaba solo
        // por id, asi que cualquier usuario con sesion podia enviar el pedidoId
        // de otra persona: si su tarjeta no tenia saldo, el pedido ajeno quedaba
        // marcado como RECHAZADO. PagoService ya comprobaba la propiedad de la
        // tarjeta, pero nadie comprobaba la del pedido.
        Pedido pedido = pedidoRepo.findByIdAndClienteCorreo(pedidoId, auth.getName())
